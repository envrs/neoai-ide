...
As a participant in the NeoPilot community, you are expected to:
...
This Code of Conduct applies to all participants in the NeoPilot community, including contributors, maintainers, and users, both online and offline. It encompasses interactions in the following areas:

- GitHub discussions and issues
- Community meetings and events
- Social media platforms
- Any other official channels related to NeoPilot
...
We invite you to contribute to NeoPilot! Whether through code, documentation, or community engagement, your participation is invaluable. For more information on how to contribute, please check our [contribution guide](https://docs.neopilot.ai/contributing/docs-contributions#how-to-contribute).

Thank you for being part of the NeoPilot community! Together, we can build a safe, respectful, and innovative space for all.
