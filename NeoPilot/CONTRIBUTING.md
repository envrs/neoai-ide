...
If you find a bug in the source code, you can help us by [submitting an issue](https://github.com/neopilot-ai/neoai-ide/issues/new?assignees=&labels=bug&projects=&template=bug_report.yaml) to our GitHub Repository. Even better, you can submit a Pull Request with a fix.

## Missing a feature?

So, you've got an awesome feature in mind? Throw it over to us by [creating an issue](https://github.com/neopilot-ai/neoai-ide/issues/new?assignees=&labels=feature-request&projects=&template=feature_request.yaml) on our GitHub Repo.

If you don't feel ready to make a code contribution yet, no problem! You can also check out the [documentation issues](https://github.com/neopilot-ai/neoai-ide/issues?q=is%3Aopen+is%3Aissue+label%3Adocumentation).
...
You can use [this view](https://github.com/neopilot-ai/neoai-ide/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) which helps new contributors find easy gateways into our project.

## Step 1: Make a fork

Fork the NeoPilot repository to your GitHub organization. This means that you'll have a copy of the repository under _your-GitHub-username/repository-name_.
...
```
git clone https://github.com/<your-GitHub-username>/NeoPilot
...
[Code of Conduct](https://github.com/neopilot-ai/neoai-ide/blob/main/CODE_OF_CONDUCT.md)
...
- **Resources**: Visit [NeoPilot documentation](https://docs.neopilot.ai/) for more helpful documentatation info.
