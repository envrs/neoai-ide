...
Previously, when suggestions failed to load (due to network errors, server issues, etc.), NeoPilot would continuously retry the request, creating an infinite loop that would hammer the server.
