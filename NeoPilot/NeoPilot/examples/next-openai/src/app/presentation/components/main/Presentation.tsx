"use client";
import { useCopilotReadable } from "@neopilot/react-core";
...
export const Presentation = ({ performResearch, setPerformResearch }: PresentationProps) => {
  ...
  //     localStorage.setItem("neopilot-messages", JSON.stringify(messages));
  //   }
  // }, [JSON.stringify(messages)]);

  // // initially load from local storage
  // useEffect(() => {
  //   const messages = localStorage.getItem("neopilot-messages");
  //   if (messages) {
