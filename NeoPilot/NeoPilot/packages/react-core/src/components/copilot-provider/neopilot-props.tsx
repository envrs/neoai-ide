import { ForwardedParametersInput } from "@neopilot/runtime-client-gql";
import { ReactNode } from "react";
import { AuthState } from "../../context/copilot-context";
import { CopilotErrorHandler } from "@neopilot/shared";
/**
 * Props for NeoPilot.
 */

export interface NeoPilotProps {
  /**
   * Your Copilot Cloud API key.
   *
   * Don't have it yet? Go to https://cloud.neopilot.ai and get one for free.
   */
  publicApiKey?: string;

  /**
   * Your public license key for accessing premium NeoPilot features.
   *
   * Don't have it yet? Go to https://cloud.neopilot.ai and get one for free.
   */
   ...
   * @remarks
   *
   * This feature is only available when using NeoPilot's hosted cloud service. To use this feature, sign up at https://cloud.neopilot.ai to get your publicApiKey. The feature allows restricting chat conversations to specific topics.
   */
  guardrails_c?: {
    validTopics?: string[];
    invalidTopics?: string[];
  ...
  /**
   * The children to be rendered within the NeoPilot.
   */
  children: ReactNode;
  ...
  /**
   * The auth config to use for the NeoPilot.
   * @remarks
   *
   * This feature is only available when using NeoPilot's hosted cloud service. To use this feature, sign up at https://cloud.neopilot.ai to get your publicApiKey. The feature allows restricting chat conversations to specific topics.
   */
  ...
  /**
   * The thread id to use for the NeoPilot.
   */
  threadId?: string;
