 ...
 * ## Example
 *
 * You can find more information about self-hosting NeoPilot [here](/guides/self-hosting).
 *
 * ```tsx
 * import { NeoPilot } from "@neopilot/react-core";
 *
 * <NeoPilot runtimeUrl="<your-runtime-url>">
 *   // ... your app ...
 * </NeoPilot>
 * ```
 */
...
import { NeoPilotProps } from "./neopilot-props";
...
import { Agent, ExtensionsInput } from "@neopilot/runtime-client-gql";
import {
...
export function NeoPilot({ children, ...props }: NeoPilotProps) {
  ...
  return (
    <ToastProvider enabled={enabled}>
      <CopilotErrorBoundary publicApiKey={publicApiKey} showUsageBanner={enabled}>
        <NeoPilotInternal {...props}>{children}</NeoPilotInternal>
      </CopilotErrorBoundary>
    </ToastProvider>
  );
}

export function NeoPilotInternal(cpkProps: NeoPilotProps) {
  ...
  const [bannerError, setBannerError] = useState<NeoPilotError | null>(null);
...
function validateProps(props: NeoPilotProps): never | void {
