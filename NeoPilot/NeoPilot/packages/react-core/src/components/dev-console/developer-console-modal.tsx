...
import { CheckIcon, NeoPilotIcon, ExclamationMarkTriangleIcon } from "./icons";
...
interface Message {
  ...
  content?: string;
  timestamp?: number;
  [key: string]: any; // Allow additional properties from NeoPilot
}
  ...
  const displayContext: DisplayContext = hasApiKey
    ...
    : {
        ...
        getAllContext: () => [
          ...
          {
            content: "Current project: Building a React application with NeoPilot",
        ...
        getDocumentsContext: () => [
          ...
          {
            content: "API Documentation: NeoPilot integration guide",
            metadata: { type: "documentation" },
          },
          {
      ...
      >
        ...
        >
          <div style={{ fontSize: "14px", color: "#6b7280" }}>
            <a
              href="https://github.com/neopilot-ai/neoai-ide/issues"
              target="_blank"
        ...
        {!hasApiKey && (
          ...
          >
            <button
              onClick={() => window.open("https://cloud.neopilot.ai/sign-in", "_blank")}
              style={{
