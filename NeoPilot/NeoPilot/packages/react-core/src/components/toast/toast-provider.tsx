import { GraphQLError } from "@neopilot/runtime-client-gql";
import React, { createContext, useContext, useState, useCallback } from "react";
import { PartialBy, NeoPilotError, Severity } from "@neopilot/shared";
...
interface ToastContextValue {
  ...
  setBannerError: (error: NeoPilotError | null) => void;
}
...
function getErrorSeverity(error: NeoPilotError): ErrorSeverity {
...
export function ToastProvider({
  ...
  const [bannerError, setBannerErrorState] = useState<NeoPilotError | null>(null);
