...
export const getErrorActions = (error: NeoPilotError) => {
  switch (error.code) {
    case NeoPilotErrorCode.MISSING_PUBLIC_API_KEY_ERROR:
      return {
        primary: {
          label: "Show me how",
          onClick: () =>
            window.open(
              "https://docs.neopilot.ai/premium#how-do-i-get-access-to-premium-features",
              "_blank",
              "noopener,noreferrer",
            ),
        },
      };
    case NeoPilotErrorCode.UPGRADE_REQUIRED_ERROR:
      return {
        primary: {
          label: "Upgrade",
          onClick: () =>
            window.open("https://cloud.neopilot.ai", "_blank", "noopener,noreferrer"),
        },
      };
    default:
      return undefined;
...
export function renderNeoPilotUsage(error: NeoPilotError, onClose?: () => void) {
