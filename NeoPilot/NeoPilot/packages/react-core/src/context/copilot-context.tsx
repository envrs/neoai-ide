...
import { Agent } from "@neopilot/runtime-client-gql";
import {
...
export interface CopilotApiConfig {
   ...
   * This is typically derived from the NeoPilotProps and used internally.
   * @experimental
   */
...
export interface CopilotContextParams {
  ...
  // banner error state
  bannerError: NeoPilotError | null;
  setBannerError: React.Dispatch<React.SetStateAction<NeoPilotError | null>>;
...
const emptyCopilotContext: CopilotContextParams = {
  ...
  copilotApiConfig: new (class implements CopilotApiConfig {
    get chatApiEndpoint(): string {
      throw new Error("Remember to wrap your app in a `<NeoPilot> {...} </NeoPilot>` !!!");
    }
