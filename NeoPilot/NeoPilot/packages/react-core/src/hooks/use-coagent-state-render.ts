 ...
 *
 * ```tsx
 * import { useCoAgentStateRender } from "@neopilot/react-core";
 *
 * type YourAgentState = {
...
import { randomId, NeoPilotAgentDiscoveryError } from "@neopilot/shared";
 ...
 *
 * https://docs.neopilot.ai/coagents/shared-state/predictive-state-updates
 */
