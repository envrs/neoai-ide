 ...
 *   <img
 *     src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/SharedStateCoAgents.gif"
...
import { Message } from "@neopilot/shared";
import { useAsyncCallback } from "../components/error-boundary/error-utils";
import { useToast } from "../components/toast/toast-provider";
import { useCopilotRuntimeClient } from "./use-copilot-runtime-client";
import { parseJson, NeoPilotAgentDiscoveryError } from "@neopilot/shared";
import { useMessagesTap } from "../components/copilot-provider/copilot-messages";
import { Message as GqlMessage } from "@neopilot/runtime-client-gql";
 ...
 * we refer to as CoAgents, checkout the documentation at https://docs.neopilot.ai/coagents/quickstart/langgraph.
 */
export function useCoAgent<T = any>(options: UseCoagentOptions<T>): UseCoagentReturnType<T> {
  ...
  useEffect(() => {
    if (availableAgents?.length && !availableAgents.some((a) => a.name === name)) {
      ...
      const agentError = new NeoPilotAgentDiscoveryError({
        agentName: name,
