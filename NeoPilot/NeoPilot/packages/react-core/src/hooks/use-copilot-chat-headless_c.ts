 ...
 * Sign up for free on [Copilot Cloud](https://cloud.neopilot.ai) to get your public license key or read more about <a href="/premium/overview">premium features</a>.
 *
 ...
 * import { useCopilotChatHeadless_c } from "@neopilot/react-core";
 *
 * export function App() {
 *   return (
 *     <NeoPilot publicApiKey="your-free-public-license-key">
 *       <YourComponent />
 *     </NeoPilot>
 *   );
 * }
 ...
 *
 * ```tsx
 * import { useCopilotChatHeadless_c, useCopilotChatSuggestions } from "@neopilot/react-core";
 *
 ...
 *
 * **Requires a publicApiKey** - Sign up for free at https://cloud.neopilot.ai/
 *
...
function useCopilotChatHeadless_c(options: UseCopilotChatOptions_c = {}): UseCopilotChatReturn_c {
  ...
  useEffect(() => {
    if (!hasPublicApiKey) {
      ...
      styledConsole.logNeoPilotPlatformMessage();
    } else {
