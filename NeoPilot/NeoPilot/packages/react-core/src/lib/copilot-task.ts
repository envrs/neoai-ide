 ...
 *
 * ```tsx
 * import { CopilotTask, useCopilotContext } from "@neopilot/react-core";
 *
 ...
 * ```
 *
 * Have a look at the [Presentation Example App](https://github.com/neopilot-ai/neoai-ide/blob/main/NeoPilot/examples/next-openai/src/app/presentation/page.tsx) for a more complete example.
 */
