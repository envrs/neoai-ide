/**
 * Suggestions utility functions for NeoPilot
 *
...
import { actionParametersToJsonSchema } from "@neopilot/shared";
import { CopilotRequestType } from "@neopilot/runtime-client-gql";
