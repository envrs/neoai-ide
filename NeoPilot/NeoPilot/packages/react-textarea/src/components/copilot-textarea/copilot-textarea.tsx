/**
 * <br/>
 * <img src="https://cdn.neopilot.ai/docs/neopilot/images/CopilotTextarea.gif" width="500" />
 *
 ...
 *
 * This component is part of the [@neopilot/react-textarea](https://npmjs.com/package/@neopilot/react-textarea) package.
 *
 * ```shell npm2yarn \"@neopilot/react-textarea"\
...
export interface CopilotTextareaProps
   ...
   * For full reference, [check the interface on GitHub](https://github.com/neopilot-ai/neoai-ide/blob/main/NeoPilot/packages/react-textarea/src/types/base/base-copilot-textarea-props.tsx#L8).
   *
   ...
   *       For full reference, please [click here](https://github.com/neopilot-ai/neoai-ide/blob/main/NeoPilot/packages/react-textarea/src/types/autosuggestions-config/suggestions-api-config.tsx#L4).
   *   </PropertyReference>
   *   <PropertyReference name="insertionApiConfig" type="InsertionApiConfig">
   *       For full reference, please [click here](https://github.com/neopilot-ai/neoai-ide/blob/main/NeoPilot/packages/react-textarea/src/types/autosuggestions-config/insertions-api-config.tsx#L4).
   *   </PropertyReference>
   * </PropertyReference>
   *
   ...
   *   Whether to disable the NeoPilot branding.
   * </PropertyReference>
   *
