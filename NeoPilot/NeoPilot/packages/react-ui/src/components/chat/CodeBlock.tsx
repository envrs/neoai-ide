...
const CodeBlock: FC<Props> = memo(({ language, value }) => {
  ...
  return (
    <div className="neoPilotCodeBlock">
      <div className="neoPilotCodeBlockToolbar">
        <span className="neoPilotCodeBlockToolbarLanguage">{language}</span>
        <div className="neoPilotCodeBlockToolbarButtons">
          <button className="neoPilotCodeBlockToolbarButton" onClick={downloadAsFile}>
            {DownloadIcon}
          </button>
          <button className="neoPilotCodeBlockToolbarButton" onClick={onCopy}>
