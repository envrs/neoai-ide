...
export const Input = ({
  ...
  // tylerslaton:
  //
  // This scrolls NeoPilot into view always. Reading the commit history, it was likely
  ...
  // forcing NeoPilot to always be in view. This code causes this because focusing an element
  ...
  return (
    <div className={`neoPilotInputContainer ${showPoweredBy ? "poweredByContainer" : ""}`}>
      <div className="neoPilotInput" onClick={handleDivClick}>
        ...
        <div className="neoPilotInputControls">
          {onUpload && (
            <button onClick={onUpload} className="neoPilotInputControlButton">
          ...
          <button
            ...
            data-neopilot-in-progress={inProgress}
            data-test-id={inProgress ? "copilot-chat-request-in-progress" : "copilot-chat-ready"}
            className="neoPilotInputControlButton"
          >
            {buttonIcon}
          </button>
        </div>
