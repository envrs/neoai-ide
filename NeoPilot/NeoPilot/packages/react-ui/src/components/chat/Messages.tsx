...
import { useCopilotChatInternal as useCopilotChat } from "@neopilot/react-core";
...
export const Messages = ({
  ...
  useEffect(() => {
    if (hasLegacyProps) {
      console.warn(
        "[NeoPilot] Legacy message render props (RenderTextMessage, RenderActionExecutionMessage, etc.) are deprecated. " +
          "Please use the unified 'RenderMessage' prop instead. " +
          "See migration guide: https://docs.neopilot.ai/migration/render-message",
      );
    }
  }, [hasLegacyProps]);
  ...
  return (
    <div className="neoPilotMessages" ref={messagesContainerRef}>
      ...
      <footer className="neoPilotMessagesFooter" ref={messagesEndRef}>
        {children}
      </footer>
    </div>
  );
