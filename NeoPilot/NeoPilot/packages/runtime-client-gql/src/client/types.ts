...
import {
  ...
  MetaEventName,
  NeoPilotLangGraphInterruptEvent as GqlNeoPilotLangGraphInterruptEvent,
  ImageMessageInput,
} from "../graphql/@generated/graphql";
import { parseJson } from "@neopilot/shared";
...
type NeoPilotLangGraphInterruptEvent<TValue extends any = any> =
  GqlNeoPilotLangGraphInterruptEvent & {
    data: GqlNeoPilotLangGraphInterruptEvent["data"] & { value: TValue };
  };

export type MetaEvent = LangGraphInterruptEvent | NeoPilotLangGraphInterruptEvent;
