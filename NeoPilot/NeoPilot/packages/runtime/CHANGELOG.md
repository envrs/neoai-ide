...
- e730369: - feat: use latest agui langgraph package
  - feat: use latest agui readyapi langgraph package and dependencies
...
- df25f34: - feat: add agui fastAPI compatible langgraph agent
  - chore: release 0.1.55 with agui langgraph readyapi support
...
- deaeca0: - feat: Add public key
  ...
  Signed-off-by: Luis Valdes <luis@neopilot.ai>
...
- 8408d58: - feat: create neopilot agui langgraph agent
...
- e95bb0e: - fix: clarify difference between lgp endpoints to readyapi endpoints
...
- 082db7a: - Added RemoteAgentAdapter and implemented NeoPilot (protocol & events).
...
- 989f159: - fix: allow NeoPilot Remote Endpoint without agents
