...
export enum LangGraphEventTypes {
  ...
  OnNeoPilotStateSync = "on_neopilot_state_sync",
  OnNeoPilotEmitMessage = "on_neopilot_emit_message",
  OnNeoPilotEmitToolCall = "on_neopilot_emit_tool_call",
  OnCustomEvent = "on_custom_event",
  OnInterrupt = "on_interrupt",
  OnNeoPilotInterrupt = "on_neopilot_interrupt",
  OnNeoPilotError = "on_neopilot_error",
}
...
type LangGraphOnNeoPilotStateSyncEvent = {
...
export type LangGraphEvent =
  ...
  | LangGraphOnNeoPilotStateSyncEvent
  | LangGraphOnCustomEvent
  | LangGraphInterruptEvent
  | NeoPilotLangGraphInterruptEvent
  | NeoPilotLangGraphErrorEvent;
