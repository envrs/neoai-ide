...
/**
 * Configuration for NeoPilot logging functionality.
 *
 * @remarks
 * Custom logging handlers require a valid NeoPilot public API key.
 * Sign up at https://docs.neopilot.ai/quickstart#get-a-copilot-cloud-public-api-key to get your key.
 */
export interface CopilotObservabilityConfig {
   ...
   *
   * @remarks
   * Using custom observability hooks requires a valid NeoPilot public API key.
   */
