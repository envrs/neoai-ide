import { Action, Parameter } from "@neopilot/shared";
...
/**
 * Extracts NeoPilot-compatible parameters from an MCP tool schema.
...
/**
 * Converts a map of MCPTools into an array of NeoPilot Actions.
