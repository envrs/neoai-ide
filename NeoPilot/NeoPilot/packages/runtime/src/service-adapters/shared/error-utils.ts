import { NeoPilotLowLevelError, NeoPilotErrorCode } from "@neopilot/shared";

/**
 * Converts service adapter errors to structured NeoPilotError format using HTTP status codes.
...
export function convertServiceAdapterError(
  ...
  const structuredError = new NeoPilotLowLevelError({
