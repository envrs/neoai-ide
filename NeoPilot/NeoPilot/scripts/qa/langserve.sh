...
mkdir -p $LANGSERVE_APP_PATH/src/app/api/neopilot/openai/

cp scripts/qa/lib/langserve/next/route.ts $LANGSERVE_APP_PATH/src/app/api/neopilot/openai/route.ts
