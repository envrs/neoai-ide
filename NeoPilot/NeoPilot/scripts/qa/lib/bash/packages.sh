...
get_latest_neopilot_versions() {
  get_latest_versions "@neopilot/backend" "@neopilot/react-core" "@neopilot/react-textarea" "@neopilot/react-ui" "@neopilot/shared"
}
...
get_latest_neopilot_prerelase_versions() {
  get_latest_prerelease_versions $1 "@neopilot/runtime" "@neopilot/react-core" "@neopilot/react-textarea" "@neopilot/react-ui" "@neopilot/shared"
}
...
yarn_install_packages() {
    ...
    info "Using NeoPilot packages: $packages"
}
