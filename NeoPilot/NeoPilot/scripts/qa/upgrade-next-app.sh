...
mkdir -p $UPGRADE_NEXT_APP_ROUTER_PATH/src/app/api/neopilot/openai/
cp scripts/qa/lib/upgrade-next-app/old/route.ts $UPGRADE_NEXT_APP_ROUTER_PATH/src/app/api/neopilot/openai/route.ts
...
cp scripts/qa/lib/upgrade-next-app/new/route.ts $UPGRADE_NEXT_APP_ROUTER_PATH/src/app/api/neopilot/openai/route.ts
