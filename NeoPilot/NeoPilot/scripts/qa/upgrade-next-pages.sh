...
echo "Fetching released versions of NeoPilot packages..."
released_packages=$(get_latest_neopilot_versions)
...
echo "Using released NeoPilot packages: $released_packages"
...
mkdir -p $UPGRADE_NEXT_PAGES_ROUTER_PATH/src/pages/api/neopilot/openai/
cp scripts/qa/lib/upgrade-next-pages/old/route.ts $UPGRADE_NEXT_PAGES_ROUTER_PATH/src/pages/api/neopilot/openai/route.ts
...
cp scripts/qa/lib/upgrade-next-pages/new/route.ts $UPGRADE_NEXT_PAGES_ROUTER_PATH/src/pages/api/neopilot/openai/route.ts
