...
<br>
  ...
  <a href="https://www.npmjs.com/package/@neopilot/react-core" target="_blank">
    <img src="https://img.shields.io/npm/v/%40neopilot%2Freact-core?logo=npm&logoColor=%23FFFFFF&label=Version&color=%236963ff" alt="NPM">
  </a>

  <a href="https://github.com/neopilot-ai/neopilot/blob/main/LICENSE" target="_blank">
    <img src="https://img.shields.io/github/license/neopilot/neopilot?color=%236963ff&label=License" alt="MIT">
  </a>
  ...
  <br/>
  <div>
    <a href="https://www.producthunt.com/posts/neopilot" target="_blank">
...
<a href="https://docs.neopilot.ai/?ref=github_readme">Read the Docs →</a>&nbsp;&nbsp;&nbsp;
<a href="https://cloud.neopilot.ai?ref=github_readme">Try Copilot Cloud →</a>&nbsp;&nbsp;&nbsp;
<a href="https://discord.gg/6dffbvGU3D?ref=github_readme">Join our Discord →</a>

## 🚀 Getting Started

1. Install: Run a simple CLI command
1. Configure: Add NeoPilot provider to your app
1. Customize: Use headless UI or the customizable pre-built components
1. Deploy: You're done!

<br />
  <a href="https://docs.neopilot.ai/#get-started-now?ref=github_readme" target="_blank">
...
<p align="center">
  <a href="https://www.neopilot.ai/examples/form-filling-copilot">
  ...
  <a href="https://www.neopilot.ai/examples/state-machine-copilot">
  ...
  <a href="https://www.neopilot.ai/examples/chat-with-your-data">
...
<h3>Have questions or need help?</h3>
  <a href="https://discord.gg/6dffbvGU3D?ref=github_readme" target="_blank">
   Join our Discord →
    ...
    <a href="https://docs.neopilot.ai/?ref=github_readme" target="_blank">
  Read the Docs →
  </a> </br>
    <a href="https://cloud.neopilot.ai?ref=github_readme" target="_blank">
   Try Copilot Cloud →
  </a>
<h3>Stay up to date with our latest releases!</h3>
  <a href="https://www.linkedin.com/company/neopilot/" target="_blank">
   Follow us on LinkedIn →
  </a> </br>
    <a href="https://x.com/neopilot" target="_blank">
   Follow us on X →
  </a> 
  
## 🙋🏽‍♂️ Contributing

Thanks for your interest in contributing to NeoPilot! 💜
...
- For documentation-related contributions, [check out the documentation contributions guide](https://docs.neopilot.ai/contributing/docs-contributions?ref=github_readme).

- Want to contribute but not sure how? [Join our Discord](https://discord.gg/6dffbvGU3D) and we'll help you out!

## 📄 License

This repository's source code is available under the [MIT License](https://github.com/neopilot-ai/neoai-ide/blob/main/LICENSE).
