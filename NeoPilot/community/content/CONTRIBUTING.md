# Contributing to NeoPilot Hacktoberfest
...
1. **Pick an Issue**: Browse [GitHub Issues](https://github.com/neopilot-ai/neoai-ide/issues) tagged `hacktoberfest` and ask to be assigned. Multiple contributors can join the same issue.  
2. **Set Up Your Environment**: Install [NeoPilot packages](https://docs.neopilot.ai/direct-to-llm/guides/quickstart) locally and make sure you can run your project.  
...
- **Resources**: See the [NeoPilot documentation](https://docs.neopilot.ai/what-is-neopilot) for setup and usage help.  
