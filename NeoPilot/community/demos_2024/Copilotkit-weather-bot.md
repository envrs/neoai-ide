...
# 1. NeoPilot-weather-Bot
This Next.js application is a weather forecasting tool that utilizes NeoPilot for
...
List the technologies and frameworks you used (e.g., NeoPilot, Next.js)
- [Next.js](https://nextjs.org)
- [Recharts](https://recharts.org)
- [Tailwind CSS](https://tailwindcss.com)
- [NeoPilot](https://neopilot.ai)
...
### GitHub Repo Link: 
[JanumalaAkhilendra/NeoPilot-weather-bot](https://github.com/JanumalaAkhilendra/NeoPilot-weather-bot)

### 5 bonus points

- If your app is live, include the link here:
- [Live app](https://neopilot-weather-bot.vercel.app/)
- A youtube video demo of NeoPilot-weather-bot is available [here](https://youtu.be/F2wiIcNrwOg)
...
Link to any bonus activities you did such as solving GitHub Issues or posting to Twitter, Dev.to, Medium, etc related to your project and NeoPilot.


#issue 602 : Build a chatbot that gives real-time weather updates using NeoPilot's AI interaction capabilities.
