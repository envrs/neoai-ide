...
### [Link-](https://github.com/Vaishnavi-Raykar/PriorityTodo---NeoPilot)
...
Link to any bonus activities you did such as solving GitHub Issues or posting to Dev.to, Twitter, etc related to your project and NeoPilot.
- A dev.to blog link - [Link](https://dev.to/vaishnavi_raykar/priority-based-todo-list-4ap6)

#issue 626 : Build a TodoList that helps to add task using NeoPilot's AI interaction capabilities.
