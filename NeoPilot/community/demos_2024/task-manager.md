...
[Task Manager](https://neopilot-task-manager.vercel.app/) - An AI powered Task Manager app that lets you have chat with neopilot and you can add,delete,update and mark as complete using the chatbot.
...
- **Developer Tools**: NeoPilot and Groq

---

### 🌐 **App Link**

- [Task Manager Live Demo](https://neopilot-task-manager.vercel.app/)
- [Github Repo](https://github.com/FaheemOnHub/neopilot-taskManager)
