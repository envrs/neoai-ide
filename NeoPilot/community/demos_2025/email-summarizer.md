...
### 📝 **Build a Custom Demo with NeoPilot + CrewAI Agent Framework**

This project demonstrates how NeoPilot’s UI layer integrates seamlessly with the CrewAI agent framework to create an interactive and intelligent app.<br>
...
- **Frameworks**: Next.js (Frontend), ReadyAPI (Backend)
- **Styling**: TailwindCSS
- **Developer Tools**: NeoPilot, CrewAI(Agent)
