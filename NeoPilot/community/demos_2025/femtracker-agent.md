...
- React 19
- TypeScript 5
- NeoPilot (AI Integration & Conversational Interface)
...
- Main Coordinator Agent (NeoPilot Integration)
- Cycle Tracker Agent
...
**Built with NeoPilot for seamless conversational AI experience**
...
FemTracker Agent is a cutting-edge women's health companion that combines the power of AI multi-agent systems with comprehensive health tracking. Built with **NeoPilot integration**, it features 8 specialized AI agents that provide personalized health insights, cycle predictions, and wellness monitoring through natural language conversations.

## ✨ Key Features

### 🤖 NeoPilot-Powered Conversational AI
- **Natural Language Interface**: Seamless conversation with health AI agents
- **Intelligent Agent Coordination**: NeoPilot orchestrates 8 specialized health agents
...
- **Main Coordinator Agent**: Routes queries to specialized agents via NeoPilot
...
# NeoPilot Agent Configuration
NEXT_PUBLIC_NEOPILOT_AGENT_NAME=main_coordinator
NEXT_PUBLIC_NEOPILOT_AGENT_DESCRIPTION="AI health companion with specialized agents for women's health tracking"
...
## 🏗️ NeoPilot Integration Architecture

### Agent Coordination Flow

```mermaid
graph TB
    subgraph "NeoPilot Interface"
        A[User Input] --> B[NeoPilot Provider]
    ...
    subgraph "Response Generation"
        H[Agent Responses] --> I[NeoPilot State]
        I --> J[User Interface]
    end
...
- **🤖 Conversational AI**: Natural language interaction via NeoPilot
...
- **NeoPilot Team** for providing exceptional AI integration capabilities
...
<br/>
<em>Built with NeoPilot • Pioneering the future of conversational healthcare</em>
<br/><br/>
