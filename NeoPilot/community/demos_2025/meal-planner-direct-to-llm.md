## 🚀 **Meal Planner with NeoPilot Direct-to-LLM Integration**

### 📝 **Intelligent Recipe Planning and Management**

This project showcases how to use NeoPilot direct-to-LLM integration to connect a React frontend with any external agent that supports AGUI (Pydantic AI in this case) through a middleware layer.
...
- **UI Components**: NeoPilot React UI (@neopilot/react-ui)
- **Styling**: Custom CSS

**Backend Middleware:**

- **Runtime**: Node/Express.js
- **Packages**: @neopilot/runtime, @ag-ui/client

**AI Agent:**

- **Framework**: Pydantic AI with ReadyAPI
...
- The React frontend uses NeoPilot UI components to provide a chat interface
...
[NeoPilot Direct-to-LLM Pydantic Agent Example](https://github.com/anand-san/neopilot-direct-to-llm-example)
