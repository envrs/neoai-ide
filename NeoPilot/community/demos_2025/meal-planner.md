...
It allows users to **add ingredients manually or using NeoPilot AI commands**, and instantly generates **3–5 structured recipes** that match the provided items.  
...
- **Developer Tools**: NeoPilot UI (`@neopilot/react-ui`, `@neopilot/react-core`)  
- **Language**: TypeScript  
...
1. **Add Ingredients**
   ...
   - Or use NeoPilot to generate ingredients via natural prompts
