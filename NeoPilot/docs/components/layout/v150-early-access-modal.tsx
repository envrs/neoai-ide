      ...
      >
        <div className="p-6">
          ...
          <div className="mb-6 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800">
            ...
            >
              <source 
                src="https://neopilot-public-assets.s3.us-east-1.amazonaws.com/corp-site/videos/cpk-150-v2.mp4" 
                type="video/mp4" 
              />
          ...
          {submitted ? (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 text-center">
              ...
              <p className="text-green-700 dark:text-green-400">
                You'll be one of the first to get early access to NeoPilot v1.50.
              </p>
            </div>
          ) : (
            /* Form */
