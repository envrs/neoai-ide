...
export const LandingExamples: CarouselExample[] = [
  {
    ...
    media: {
      type: "video",
      src: "https://cdn.neopilot.ai/docs/neopilot/images/examples/spreadsheets.mp4"
    },
    links: {
      source: "https://github.com/neopilot-ai/demo-spreadsheet",
  ...
  },
  {
    ...
    media: {
      type: "video",
      src: "https://cdn.neopilot.ai/docs/neopilot/images/examples/banking.mp4"
    },
    links: {
      source: "https://github.com/neopilot-ai/demo-banking",
  ...
  },
  {
    ...
    media: {
      type: "video",
      src: "https://cdn.neopilot.ai/docs/neopilot/images/langgraph/tutorials/ai-travel-app/demo.mp4"
    },
    links: {
      source: "https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-travel?ref=travel-tutorial",
  ...
  },
  {
    ...
    media: {
      type: "video",
      src: "https://cdn.neopilot.ai/docs/neopilot/images/examples/research.mp4"
    },
    links: {
      source: "https://github.com/neopilot-ai/neoai-ide/blob/main/examples/coagents-research-canvas/readme.md",
...
export const CoAgentsExamples: CarouselExample[] = [
  {
    icon: LuLightbulb,
    title: "Introduction",
    description: "Hear from the CEO of NeoPilot, Atai Barkai, and learn how CoAgents are paving the way for the next generation of AI-native apps.",
    media: {
      type: "youtube",
      src: "tVjVYJE-Nic"
    },
