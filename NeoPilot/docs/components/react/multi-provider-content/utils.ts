...
export const quickStartProviders: ProvidersConfig = {
  openai: {
    id: "openai",
    title: "OpenAI",
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/openai.png",
  ...
  azure: {
    id: "azure",
    title: "Azure OpenAI",
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/azure.png",
    packageName: "openai",
...
const openai = new OpenAI({
  ...
  anthropic: {
    ...
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/anthropic.png",
  ...
  groq: {
    id: "groq",
    title: "Groq",
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/groq.png",
  ...
  google: {
    ...
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/google.png",
  ...
  bedrock: {
    ...
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/amazon-aws.png",
  ...
  langchain: {
    ...
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/langchain.png",
  ...
  empty: {
    ...
    icon: "https://cdn.neopilot.ai/docs/neopilot/icons/empty.svg",
