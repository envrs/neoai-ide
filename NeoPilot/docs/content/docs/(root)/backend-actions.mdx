  ...
  <div className="flex items-center gap-6">
    ...
    <div className="flex-1">
      <p className="text-base leading-relaxed mb-4">
        Backend Actions are primarily designed for Direct to LLM applications, where you need explicit server-side functions that the LLM can call. NeoPilot provides multiple implementation approaches.
      </p>
    </div>
  </div>
</Callout>
...
For agent-based applications, backend functionality is usually implemented as **agent tools** or **framework-specific integrations** rather than NeoPilot backend actions. 