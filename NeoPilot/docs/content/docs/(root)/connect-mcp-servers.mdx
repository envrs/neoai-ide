...
<Steps>
  ...
  <TailoredContent
    ...
    header={
        <div>
            <p className="text-xl font-semibold">Use the NeoPilot CLI</p>
        </div>
    }
  >
    <TailoredContentOption
      id="use-cli"
      title="Use the NeoPilot CLI"
    ...
    >
      <Step>
        ...
        ```bash
        npx neopilot@latest init -m MCP
        ```
      </Step>
    </TailoredContentOption>
    <TailoredContentOption
    ...
    >
      <Step>
        ...
        export default function App() {
          return (
            <NeoPilot publicApiKey="<replace_with_your_own>">
              {/* Your app content */}
            </NeoPilot>
          );
        }
