---
title: NeoPilot in Action
description: Need some inspiration? Check out some things we've built with NeoPilot.
---
...
Need some inspiration? Check out some things we've built with NeoPilot.

<Cards className="gap-6">
  <Card
    className="md:col-span-2 p-6 py-10 rounded-xl text-base" 
    title="Feature Viewer"
    description="Learn about all of the best features NeoPilot has to offer with an interactive experience."
