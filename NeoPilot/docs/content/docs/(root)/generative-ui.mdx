...
<video src="https://cdn.neopilot.ai/docs/neopilot/images/langgraph/agentic-generative-ui.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
