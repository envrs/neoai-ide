...
<video src="https://cdn.neopilot.ai/docs/neopilot/images/langgraph/human-in-the-loop-example.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
