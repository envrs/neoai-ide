---
title: Introduction to NeoPilot
...
import { NeoPilotHero } from "@/components/branding/NeoPilotHero";

<div className="grid grid-cols-1 2xl:grid-cols-2 2xl:gap-10">
  <div>
    ## What is NeoPilot?
    NeoPilot is the easiest way to add AI copilots - intelligent, context-aware assistants - into your app.

    NeoPilot connects your app's logic, state, and user context to the AI agents that deliver the animated and interactive part of your app experience — across both embedded UIs and fully headless interfaces. It gives you the tools to build, deploy, and monitor AI-assisted features that feel intuitive, helpful, and deeply integrated.

    By decoupling your application from any specific model or agent architecture, NeoPilot gives you the freedom to evolve your AI stack without rethinking your user experience.
  </div>
  <video src="https://cdn.neopilot.ai/docs/neopilot/videos/coagents/overview.mp4" autoPlay controls loop muted playsInline className="rounded-xl shadow-lg mx-auto mt-auto" />
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-6 mb-12">
  ...
  <div className="lg:col-span-4 border-2 border-border px-6 pt-1 pb-4 rounded-xl text-center transition-colors min-h-[180px] flex flex-col justify-between">
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-4">Bootstrap your NextJS<br />application with NeoPilot</p>
    </div>
    <div className="h-12 flex items-center justify-center">
...
NeoPilot works with any LLM or agent framework.  Choose an integration to see the full feature set.

<IntegrationsGrid />

## Key Features
Learn why NeoPilot is used by thousands of developers around the world.

<div className="flex flex-row gap-8 my-8">
  <div className="w-1/2">
    <Accordions>
      <Accordion title="Designed for Agentic Applications">
        Unlike general-purpose frameworks, NeoPilot is designed from the ground up to support agent-driven user experiences.
      </Accordion>
      ...
      <Accordion title="Headless Mode">
        Use NeoPilot logic and messaging infrastructure without a proscribed visual interface—full programmatic control.
      </Accordion>
  ...
  <div className="w-1/2">
    <Accordions>
      <Accordion title="Full Flexibility">
        Bring your own LLMs, tools, and agents — NeoPilot doesn't lock you into a specific stack.
      </Accordion>
