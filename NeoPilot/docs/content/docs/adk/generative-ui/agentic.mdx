...
{/* <IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/adk-middleware/feature/agentic_generative_ui?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/adk-middleware/feature/agentic_generative_ui?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/> */}
