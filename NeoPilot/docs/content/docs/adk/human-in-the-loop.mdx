...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/adk-middleware/feature/human_in_the_loop?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/adk-middleware/feature/human_in_the_loop?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
