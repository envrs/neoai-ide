        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing ADK agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f adk
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have an ADK agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                ```bash
                uv add ag-ui-adk google-adk uvicorn readyapi
                ```

                <Callout type="info" title="What is AG-UI?">
                  AG-UI is an open protocol for frontend-agent communication. The `ag-ui-adk` package provides ADK integration that NeoPilot can connect to.
                </Callout>
            </Step>
            <Step>
                ### Configure your environment
            ...
            <Step>
                ...
                from ag_ui_adk import ADKAgent, add_adk_readyapi_endpoint
                ...
                app = ReadyAPI()
                add_adk_readyapi_endpoint(app, adk_agent, path="/")
            ...
            <Step>
                ...
                Create an API route to connect NeoPilot to your ADK agent:
