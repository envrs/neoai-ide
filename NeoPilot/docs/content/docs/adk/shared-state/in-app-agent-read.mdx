...
<Callout type="info">
  This example demonstrates reading from shared state in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/adk-middleware/feature/shared_state).
</Callout>
