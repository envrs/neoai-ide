...
title: Introduction
icon: "custom/ag2"
description: Bring your AG2 agents to your users with NeoPilot via AG-UI.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Give your AG2 agents real user-interactivity using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  ...
  featuresLink="https://feature-viewer.neopilot.ai"
  supportedFeatures={[
    {
      title: "Generative UI",
  ...
  architectureImage="https://cdn.neopilot.ai/docs/neopilot/images/coagents/ag2/architecture.png"
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
