...
This quickstart guide shows how to create a simple **Personalized Travel Planner** using AG2 and NeoPilot. In just minutes, you'll build an application that collects user travel preferences and generates custom day-by-day itineraries tailored to their destination, budget, and interests.
...
<Steps>
    <Step>
        ...
        <Tabs groupId="language_ag2_agent" items={["Python"]} persist>
            <Tab value="Python">
                ```bash
                git clone https://github.com/ag2ai/ag2-neopilot-starter.git
                cd ag2-neopilot-starter
                ```
            </Tab>
        </Tabs>
    </Step>
    ...
    <Step>
        ### Set Up the NeoPilot UI
        
        The last step is to use NeoPilot's UI components to render the chat interaction with your agent.
    ...
    <Step>
        ...
        <img src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/ag2/quick-start-1.png" className="rounded-lg shadow-xl"/>
        <img src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/ag2/quick-start-2.png" className="rounded-lg shadow-xl"/>
    </Step>
...
You've now got a simple Personalized Travel Planner running with NeoPilot! This demonstrates how quickly you can build practical AI applications by combining AG2's conversational capabilities with NeoPilot's user interface components.
