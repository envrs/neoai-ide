...
title: Introduction
icon: "custom/agno"
description: Bring your Agno agents to your users with NeoPilot via AG-UI.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Give your Agno agents real user-interactivity using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  ...
  featuresLink="https://feature-viewer.neopilot.ai/agno/feature/agentic_chat"
  supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.neopilot.ai/agno/feature/tool_based_generative_ui",
