        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing Agno agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f agno
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have an Agno agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                ```bash
                uv add agno readyapi uvicorn openai ag-ui-protocol
                ```
            </Step>
            <Step>
                ### Configure your environment
            ...
            <Step>
                ...
                <Callout type="info" title="What is AG-UI?">
                  AG-UI is an open protocol for frontend-agent communication. AgentOS with the AGUI interface creates an ASGI app that NeoPilot can connect to.
                </Callout>
            </Step>
            <Step>
            ...
            <Step>
                ...
                ```npm
               @neopilot/react-ui @neopilot/react-core @neopilot/runtime @ag-ui/agno
                ```
            </Step>
            <Step>
                ### Setup Copilot Runtime

                Create an API route to connect NeoPilot to your Agno agent:
