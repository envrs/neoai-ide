...
description: Bring your AWS Strands agents to your users with NeoPilot via AG-UI.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Give your AWS Strands agents real user-interactivity using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  ...
  featuresLink="https://feature-viewer.neopilot.ai/aws-strands/feature/agentic_chat"
  supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.neopilot.ai/aws-strands/feature/tool_based_generative_ui",
    ...
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai/aws-strands/feature/shared_state",
