        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing Strands agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f strands
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have a Strands agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                ```bash
                uv add ag-ui-strands "strands-agents[OpenAI]" readyapi uvicorn
                ```
            </Step>
            <Step>
                ### Configure your environment
            ...
            <Step>
                ...
                <Callout type="info" title="What is AG-UI?">
                  AG-UI is an open protocol for frontend-agent communication. The `create_strands_app` function creates an ASGI app that NeoPilot can connect to.
                </Callout>
            </Step>
            <Step>
            ...
            <Step>
                ...
                Create an API route to connect NeoPilot to your Strands agent:
                ...
                export default function RootLayout({ children }: {children: React.ReactNode}) {
                  return (
                    <html lang="en">
                      <body>
                        {/* [!code highlight:3] */}
                        <NeoPilot runtimeUrl="/api/neopilot" agent="strands_agent">
                          {children}
                        </NeoPilot>
                      </body>
                    </html>
