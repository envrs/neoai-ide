...
## What is this?
NeoPilot allows you to chat with an LLM that has the ability to kick off your crews. This is a great way to enable natural conversations that flow
...
## How does this work?
NeoPilot provides a *"llm-in-the-middle"* chat that will communicate with your user to determine which Crew to kick off and gather the necessary input data
in order to kick off the Crew.

Once the Crew is kicked-off, NeoPilot will handle streaming thoughts, progress, interrupts, and results back to the user.
...
NeoPilot provides a variety of different batteries-included components to choose from when creating Crew-enabled applications. They scale
