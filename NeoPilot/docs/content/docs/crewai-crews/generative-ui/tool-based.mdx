...
<Callout>
  ...
  project](https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-starter-crewai-crews).
</Callout>
...
If you don't already have an agent, you can use the [coagent starter](https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-starter-crewai-crews) as a starting point
