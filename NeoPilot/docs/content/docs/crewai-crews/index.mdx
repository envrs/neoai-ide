...
title: Introduction
icon: "custom/crewai"
description: Bring your CrewAI Crews agents to your users with NeoPilot.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Create sophisticated multi-agent workflows using CrewAI and NeoPilot. Orchestrate teams of specialized agents to solve complex problems together."
  bannerImage="https://cdn.neopilot.ai/docs/neopilot/images/coagents/SharedStateCoAgents.gif"
  guideLink="/crewai-crews/quickstart"
  initCommand="npx neopilot@latest init"
  featuresLink="https://feature-viewer.neopilot.ai/crewai/feature/agentic_chat?frameworkPicker=false"
   supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.neopilot.ai/crewai/feature/agentic_chat",
    ...
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai/crewai/feature/human_in_the_loop",
    ...
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai/crewai/feature/shared_state",
      videoUrl: "https://cdn.neopilot.ai/docs/neopilot/videos/coagents/shared-state.mp4"
    }
  ]}
  architectureImage="https://cdn.neopilot.ai/docs/neopilot/images/coagents/crew-ai/crews/architecture.png"
  liveDemos={[
    {
      type: "canvas",
