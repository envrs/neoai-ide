...
<Steps>
    ...
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest init -m CrewAI --crew-type Crews
                ```
            </Step>
        ...
        >
            <Step>
                ...
                <img src="https://cdn.neopilot.ai/docs/neopilot/images/copilot-cloud/crew-cpk-setup.gif" alt="CrewAI Copilot Setup" className="rounded-lg shadow-xl mt-4" />
            </Step>
            ...
            <Step>
                ...
                Place the following snippet in your **main page** (e.g. `page.tsx` in Next.js) or wherever you want to use NeoPilot. It simply imports the `QuickstartCrew` component from our **crew-quickstart.tsx** file and renders it.
    ...
    <Step>
        ### 🎉 Talk to your agent!
        Congrats! You've successfully integrated your CrewAI Enterprise agent with NeoPilot.
...
You've now got a CrewAI Crew running in NeoPilot! Now you can start exploring the various ways that NeoPilot
