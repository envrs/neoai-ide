...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/emit-messages.mp4"
...
In CrewAI, messages are only emitted when a function is completed. NeoPilot allows you to manually emit messages
...
<Steps>
    ...
    <Step>
        ...
        The `neopilot_emit_message` method allows you to emit messages early in a functions's execution to communicate status updates to the user. This is particularly useful for long running tasks.
        ...
        <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
            <Tab value="Python">
                ...
                from neopilot.crewai import neopilot_emit_message # [!code highlight]
                # ...
                ...
                async def start(self):
                    ...
                    await neopilot_emit_message(intermediate_message)

                    # simulate a long running task
                    await asyncio.sleep(2)

                    response = neopilot_stream(
                        completion(
                            model="openai/gpt-4o",
                            messages=[
