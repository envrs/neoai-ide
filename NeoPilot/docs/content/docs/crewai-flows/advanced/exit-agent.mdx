...
After your agent has finished a workflow, you'll usually want to explicitly end that loop by calling the `neopilot_exit()` method in your Python code.
        ...
        <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
            <Tab value="Python">
                ...
                async def send_email(self):
                    ...
                    await neopilot_exit() # [!code highlight]
                ```
            </Tab>
        </Tabs>
    </Step>
