---
title: "Customize UI"
description: "Customize the look, feel, and functionality of NeoPilot's UI components."
icon: "lucide/Settings"
---
import { MessageCircleIcon, BrushIcon, PuzzleIcon, SettingsIcon } from "lucide-react";

NeoPilot offers a variety of ways to create a UI interface for your Copilots and CoAgents. This ranges
...
<Cards>
  <Card
    ...
    description="Get started quickly with NeoPilot's ready-to-use UI components."
  ...
  <Card
    ...
    description="Customize the appearance of NeoPilot's pre-built components with your own styles."
  ...
  <Card
    ...
    description="Build your UI from scratch using NeoPilot's hooks and core functionality."
    href="./custom-look-and-feel/headless-ui"
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    title={<div className="mb-3"><SettingsIcon className="inline mr-2" />Markdown Rendering</div>}
    description="Modify NeoPilot's use of markdown to display elements within the assistant arrow text, such as source citing and reasoning steps."
