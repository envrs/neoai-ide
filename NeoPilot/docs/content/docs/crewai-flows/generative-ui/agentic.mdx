...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/agentic-generative-ui.mp4"
...
<Callout>
  ...
  project](https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-starter-crewai-flows).
</Callout>
...
<Steps>
  <Step>
    ### Run and Connect your CrewAI Flow to NeoPilot
    ...
    This guide uses the [CoAgents starter repo](https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-starter-crewai-flows) as its starting point.

  </Step>
  <Step>
    ### Define your agent state
    If you're not familiar with CrewAI, your flows are stateful. As you progress through function, a state object is updated between them. NeoPilot
    ...
    <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
        <Tab value="Python">
          ...
          # ...
          from neopilot.crewai import NeoPilotState # extends MessagesState
          # ...
  ...
  <Step>
    ...
    <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
      <Tab value="Python">
        ...
        from neopilot.crewai import neopilot_stream, NeoPilotState, neopilot_emit_state
        import asyncio
        ...
        async def chat(self):
            ...
            await neopilot_emit_state(self.state)
