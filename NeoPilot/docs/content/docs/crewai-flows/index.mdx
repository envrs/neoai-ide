...
title: Introduction
icon: "custom/crewai"
description: Bring your CrewAI Flows agents to your users with NeoPilot.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Let your users collaborate with your CrewAI Flow-based agents using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  ...
  featuresLink="https://feature-viewer.neopilot.ai/crewai/feature/agentic_chat"
  supportedFeatures={[
    {
      title: "Generative UI",
  ...
  architectureVideo="https://cdn.neopilot.ai/docs/neopilot/images/coagents/crew-ai/flows/crews-interaction-layer.mp4"
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
