...
import NeoPilotCloudNeoPilotProvider from "@/snippets/copilot-cloud-configure-neopilot-provider.mdx";
import { Accordions, Accordion } from "fumadocs-ui/components/accordion";
import FindYourCopilotRuntime from "@/snippets/find-your-copilot-runtime.mdx";
import CloudNeoPilotProvider from "@/snippets/coagents/cloud-configure-neopilot-provider.mdx";
import SelfHostingCopilotRuntimeConfigureNeoPilotProvider from "@/snippets/coagents/self-host-configure-neopilot-provider.mdx";
...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/chat-example.mp4"
    ...
    header={
        <div>
            ...
            <p className="text-base">
                Bootstrap with the new <span className="text-indigo-500 dark:text-indigo-400">NeoPilot CLI (Beta)</span> or code along with us to get started.
            </p>
        </div>
    }
>
    <TailoredContentOption
        id="cli"
        title="Use the NeoPilot CLI (NextJS only)"
    ...
    >
        <Step>
            ...
            ```bash
            npx neopilot@latest init -m CrewAI --crew-type Flows
            ```
        </Step>
        <Step>
            ### 🎉 Talk to your agent!
    ...
    >
        <Step>
            ...
            1. Go to [Copilot Cloud](https://cloud.neopilot.ai), sign in and click Get Started
            ...
            <img src="https://cdn.neopilot.ai/docs/neopilot/images/copilot-cloud/crewai-flow-cpk-setup.gif" alt="CrewAI Flow Copilot Setup" className="rounded-lg shadow-xl mt-4" />
        </Step>

        <Step>
            ### Install NeoPilot
            First, install the latest packages for NeoPilot into your frontend.
            ```npm
        ...
        <Step>
            ...
            Place the following snippet in your **main page** (e.g. `page.tsx` in Next.js) or wherever you want to use NeoPilot.
             ...
             */
            const agentName =
              process.env.NEXT_PUBLIC_NEOPILOT_AGENT_NAME || "DefaultAgent";
            ...
            // App Component: Main wrapper that provides NeoPilot context
        ...
        <Step>
            ...
            <video src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/chat-example.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
...
You've now got a CrewAI Flow running in NeoPilot! Now you can start exploring the various ways that NeoPilot
