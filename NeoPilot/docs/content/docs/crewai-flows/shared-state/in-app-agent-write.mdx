...
<Steps>
  <Step>
    ...
    If you don't already have an agent, you can use the [coagent starter](https://github.com/neopilot-ai/neopilot/tree/main/examples/coagents-starter-crewai-flows) as a starting point
