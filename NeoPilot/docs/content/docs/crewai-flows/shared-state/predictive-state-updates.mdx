...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/intermediate-state-render.mp4"
    ...
    <Step>
        ...
        <Tabs groupId="language_crewai-flows_agent" items={["Python"]} persist>
            <Tab value="Python">
                ...
                from neopilot.crewai import NeoPilotState
        ...
        >
            ...
            >
                ...
                <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
                    <Tab value="Python">
                        ```python title="agent.py"
                        from neopilot.crewai import neopilot_emit_state # [!code highlight]
                        ...
                        class SampleAgentFlow(Flow):
                            ...
                            async def start_flow(self):
                                ...
                                for step in steps:
                                    ...
                                    await neopilot_emit_state(self.state) # [!code highlight]
                ...
                <Tabs groupId="language_crewai-flows_agent" items={['Python']} default="Python" persist>
                    <Tab value="Python">
                        ...
                        class SampleAgentFlow(Flow):
                            ...
                            @start
                            async def start_flow(self):
                                # Tell NeoPilot to treat step progress tool calls as predictive of the final state
