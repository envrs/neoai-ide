...
description: "Connect your NeoPilot application to an agent deployed on LangGraph Platform."
...
<Steps>
    ...
    First, you need to host your agent so that NeoPilot can access it.
        ...
        >
            ...
            <Accordions className="my-4">
                <Accordion title="Haven't setup Copilot Cloud yet? Click here!" >
                    Copilot Cloud hooks into your NeoPilot provider, so you'll need to set it up first if you haven't already.
                    <CopilotCloudConfigureNeoPilotProviderSnippet components={props.components} />
                </Accordion>
            </Accordions>
...
For production deployments, you'll want to implement proper authentication to ensure users can only access their own data and threads. NeoPilot supports passing user authentication tokens to your LangGraph Platform agents.
