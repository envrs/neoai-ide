...
description: "Implement native backend actions using TypeScript or Node.js in NeoPilot."
...
By using this method, you can create powerful, context-aware backend actions that integrate seamlessly with your NeoPilot application.