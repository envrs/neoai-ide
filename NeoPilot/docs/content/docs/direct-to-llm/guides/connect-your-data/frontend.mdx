...
For your copilot to best answer your users' needs, you will want to provide it with **context-specific**, **user-specific**, and oftentimes **realtime** data. NeoPilot makes it easy to do so.
...
<Steps>
  ...
  <Step>
    ...
    <div className="mt-2 mb-4">
      <img 
        src="https://cdn.neopilot.ai/docs/neopilot/images/connect-your-data-example.gif" 
