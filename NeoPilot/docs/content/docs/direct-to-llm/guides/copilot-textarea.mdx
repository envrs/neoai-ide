...
<Callout type="warn">
  This guide assumes you have completed the [quickstart](/quickstart) and have successfully set up NeoPilot.
</Callout>

<Steps>
<Step>
### Install `@neopilot/react-textarea`
    
```npm
npm install @neopilot/react-textarea
```
</Step>
<Step>
### Import Styles 
