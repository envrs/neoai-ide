...
<Accordions>
  <Accordion title="Related Hooks for Different Use Cases">
    While `useFrontendTool` is for frontend tools with handlers, NeoPilot provides other specialized hooks:
...
<Frame>
  <img 
    src="https://cdn.neopilot.ai/docs/neopilot/images/copilot-action-example.gif" 
...
<Cards>
  ...
  <Card
    ...
    description="Learn how to render custom UI components alongside your tools, directly in the NeoPilot chat window."
