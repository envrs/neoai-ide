...
<Tabs groupId="gen-ui-type" items={['Render a component', 'Fetch data & render', 'renderAndWaitForResponse (HITL)', 'Render strings', 'Catch all renders']}>
  ...
  <Tab value="Render a component">
    ...
    <Frame>
      <img
        src="https://cdn.neopilot.ai/docs/neopilot/images/render-only-example.png"
  ...
  <Tab value="Fetch data & render">
    ...
    <Frame>
      <img
        src="https://cdn.neopilot.ai/docs/neopilot/images/fetch-and-render.gif"
  ...
  <Tab value="Render strings">
    ...
    <Frame className="my-0">
      <img src="https://cdn.neopilot.ai/docs/neopilot/images/concepts/generative-ui/render-string.gif" className="w-[300px] p-0" alt="String rendering example" />
    </Frame>
  ...
  <Tab value="Catch all renders">
    ...
    ```tsx
    import { useDefaultTool, CatchAllToolRenderProps } from "@neopilot/react-core";
