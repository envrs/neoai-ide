...
description: Bring your LLMs to your users with NeoPilot.
hideHeader: true
---
...
<FrameworkOverview
  ...
  supportedFeatures={[
    ...
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai/direct-to-llm/feature/mcp",
      imageUrl: "https://cdn.neopilot.ai/docs/neopilot/images/copilot-action-example.gif"
    },
  ]}
  architectureImage="https://cdn.neopilot.ai/docs/neopilot/images/architecture-diagram.png"
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
