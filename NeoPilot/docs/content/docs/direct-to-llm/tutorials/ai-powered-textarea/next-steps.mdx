...
- **Start app:** [GitHub](https://github.com/neopilot-ai/example-textarea/tree/base-start-here) | [Stackblitz Sandbox](https://stackblitz.com/github/neopilot/example-textarea/tree/base-start-here?file=lib%2Fhooks%2Fuse-tasks.tsx)
- **Final app:** [GitHub](https://github.com/neopilot-ai/example-textarea/tree/final) | [Stackblitz Sandbox](https://stackblitz.com/github/neopilot/example-textarea/tree/final?file=lib%2Fhooks%2Fuse-tasks.tsxd)
...
- Follow the [Todos App Copilot tutorial](/tutorials/ai-todo-app/overview) to learn more about NeoPilot.
