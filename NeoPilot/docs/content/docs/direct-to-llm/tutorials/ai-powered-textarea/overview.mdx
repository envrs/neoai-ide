...
<Link href="https://github.com/neopilot-ai/example-textarea?ref=docs-tutorial" className="no-underline" target="_blank">
...
<div className="flex flex-col shadow-lg rounded-lg my-4">
  <div className="bg-neutral-800 h-11 rounded-t-lg flex items-center px-4">
    <div className="flex-1 text-center text-white font-medium">NeoPilot Todo List Copilot Demo</div>
  </div>
  <iframe
