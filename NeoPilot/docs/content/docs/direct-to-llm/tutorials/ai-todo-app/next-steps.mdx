...
- **Start app:** [GitHub](https://github.com/neopilot-ai/example-todos-app/tree/base-start-here) | [Stackblitz Sandbox](https://stackblitz.com/github/neopilot/example-todos-app/tree/base-start-here?file=lib%2Fhooks%2Fuse-tasks.tsx)
- **Final app:** [GitHub](https://github.com/neopilot-ai/example-todos-app/tree/final) | [Stackblitz Sandbox](https://stackblitz.com/github/neopilot/example-todos-app/tree/final?file=lib%2Fhooks%2Fuse-tasks.tsxd)
...
- Follow the [Textarea Autocomplete tutorial](/tutorials/ai-powered-textarea/overview) to learn more about NeoPilot.
