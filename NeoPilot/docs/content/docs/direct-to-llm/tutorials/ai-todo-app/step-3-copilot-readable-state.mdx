...
Let's quickly review how our app's state works. Open up the [`lib/hooks/use-tasks.tsx`](https://github.com/neopilot-ai/example-todos-app/blob/base-start-here/lib/hooks/use-tasks.tsx) file.
