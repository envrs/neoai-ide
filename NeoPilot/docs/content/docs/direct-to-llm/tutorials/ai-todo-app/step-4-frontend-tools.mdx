...
Once again, let's take a look at our app's state in the [`lib/hooks/use-tasks.tsx`](https://github.com/neopilot-ai/example-todos-app/blob/base-start-here/lib/hooks/use-tasks.tsx#L19-L33) file.
...
The [`useFrontendTool`](/reference/hooks/useFrontendTool) hook makes tools available to our copilot. Let's implement it in the [`lib/hooks/use-tasks.tsx`](https://github.com/neopilot-ai/example-todos-app/blob/base-start-here/lib/hooks/use-tasks.tsx) file.

```tsx filename="lib/hooks/use-tasks.tsx" showLineNumbers {3-3,8-22,24-38,40-61}
// ... the rest of the file

import { useCopilotReadable, useFrontendTool } from "@neopilot/react-core"; // [!code highlight]
...
You can check out the full reference for the `useFrontendTool` hook [here](https://docs.neopilot.ai/reference/hooks/useFrontendTool).
