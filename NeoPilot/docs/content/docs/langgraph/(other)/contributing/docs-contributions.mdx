...
<Steps>
  ...
  First, head over to the [NeoPilot GitHub repository](https://github.com/neopilot-ai/neoai-ide) and create a fork.
  ...
  Once you are happy with your changes, you can commit and push them. Then, head over to the [Pull Requests page](https://github.com/neopilot-ai/neoai-ide/pulls) and create a pull request. Thank you for your contribution!
  </Step>
</Steps>
