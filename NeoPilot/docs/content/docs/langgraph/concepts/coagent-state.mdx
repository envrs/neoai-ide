...
<Frame className="mb-10">
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/coagents-state-diagram.png" alt="Agentic Copilot State Diagram" />
</Frame>
...
While your agent runs, you can emit state updates using NeoPilot's `emit_intermediate_state` function, ensuring your UI stays synchronized
