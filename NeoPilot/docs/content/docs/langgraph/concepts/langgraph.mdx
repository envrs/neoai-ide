---
title: LangGraph
description: An agentic framework for building LLM applications that can be used with NeoPilot.
icon: custom/langchain
---

<Frame>
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/coagents-highlevel-overview.png" alt="CoAgents High Level Overview" className="mb-10"/>
</Frame>

LangGraph is an agentic framework for building LLM applications that can be used with NeoPilot. It is built on top of LangChain's
...
- **Multi-actor**: CoAgents allow for multiple agents to interact with each other. NeoPilot acts as the "ground-truth"
...
allows you to build, manage, and deploy graphs that NeoPilot can interface with. For more information checkout the official
