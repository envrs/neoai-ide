...
<Steps>
    ...
    <Step>
        ...
        <video src="https://cdn.neopilot.ai/docs/neopilot/images/frontend-actions-demo.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
    </Step>
</Steps>
