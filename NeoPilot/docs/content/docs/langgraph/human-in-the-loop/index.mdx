...
<video src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/human-in-the-loop-example.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
...
<Frame className="my-0">
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/coagents-hitl-infographic.png" alt="Agentic Copilot Human in the Loop" className="mt-4 mb-0 shadow-md" />
</Frame>
...
NeoPilot provides two main approaches for HITL LangGraph workflows - interrupt and node-based.
