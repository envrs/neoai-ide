...
<Callout type="info">
  This example demonstrates interrupt-based human-in-the-loop (HITL) in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/langgraph/feature/human_in_the_loop).
</Callout>
...
This guide will show you how to both use `interrupt` and how to integrate it with NeoPilot.
...
interaction, however [NeoPilot's SDKs provide helpers to alleviate this](#make-your-agent-aware-of-interruptions).
...
<Step>
    ...
    import { useLangGraphInterrupt } from "@neopilot/react-core"; // [!code highlight]
    // ...
...
<video src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/interrupt-flow.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
</Step>
</Steps>
