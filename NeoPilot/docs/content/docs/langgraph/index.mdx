...
description: Bring your LangGraph agents to your users with NeoPilot via AG-UI.
hideHeader: true
---
...
<FrameworkOverview
  ...
  subheader="Give your LangGraph agents real user-interactivity using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  ...
  featuresLink="https://feature-viewer.neopilot.ai/langgraph/feature/agentic_chat"
  supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.neopilot.ai/langgraph/feature/tool_based_generative_ui",
    ...
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai/langgraph/feature/shared_state",
      videoUrl: "https://cdn.neopilot.ai/docs/neopilot/videos/coagents/shared-state.mp4"
    }
  ]}
  architectureImage="https://cdn.neopilot.ai/docs/neopilot/images/coagents/coagents-highlevel-overview.png"
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
