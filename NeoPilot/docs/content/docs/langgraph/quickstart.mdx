        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing LangGraph agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                <Tabs groupId="language_langgraph_agent" items={['Python', 'JavaScript']} persist>
                    <Tab value="Python">
                        ```bash
                        npx neopilot@latest create -f langgraph-py
                        ```
                    </Tab>
                    <Tab value="JavaScript">
                        ```bash
                        npx neopilot@latest create -f langgraph-js
                        ```
                    </Tab>
                </Tabs>
            </Step>
        ...
        <TailoredContentOption
            ...
            description="I already have a LangGraph agent and want to add NeoPilot."
        >
            <Step>
                ### Frontend Setup
            ...
            <Step>
                ...
                ```npm
                @neopilot/react-ui @neopilot/react-core @neopilot/runtime
                ```
            </Step>
            <Step>
            ...
            <Step>
              ...
              import { CopilotSidebar } from "@neopilot/react-ui"; // [!code highlight]
