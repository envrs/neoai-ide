...
<Callout type="info">
  This example demonstrates reading from shared state in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/langgraph/feature/shared_state).
</Callout>
...
<Steps>
  ...
  <Step>
    ...
    <Frame>
      <ImageZoom src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/read-agent-state.png" alt="read agent state" width={1000} height={1000} className="my-0"/>
    </Frame>
