...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/langgraph/feature/shared_state?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/langgraph/feature/shared_state?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Callout type="info">
  This example demonstrates writing to shared state in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/langgraph/feature/shared_state).
</Callout>
...
when your agent is calling tools. NeoPilot allows you to fully customize how these tools are rendered in the chat.
...
<Steps>
  ...
  <Step>
    ...
    <video src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/write-agent-state.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />
    <Callout>
...
import { TextMessage, MessageRole } from "@neopilot/runtime-client-gql";  // [!code highlight]
