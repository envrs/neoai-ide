...
<video src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/research-ana/final-results.mp4" className="rounded-lg shadow-xl" loop playsInline controls autoPlay muted />

<div className="flex flex-row gap-2">
  <Button size="lg" asChild className="flex gap-2 items-center">
    <Link href="https://github.com/neopilot-ai/open-research-ANA" className="no-underline" target="_blank">
...
In this tutorial, we'll build a Research Agent Native Application (ANA) using NeoPilot. Starting with a basic application, we'll add agent capabilities step by step.
...
- 🛠️ Creating interactive agent experiences with NeoPilot
