...
contain all of the logic we need to build our research ANA except for the NeoPilot
...
<ImageZoom src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/research-ana/lgs-overview.png" height={1000} width={1000} className="rounded-lg shadow-lg"/>
