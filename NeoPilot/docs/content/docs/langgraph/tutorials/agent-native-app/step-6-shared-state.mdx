...
NeoPilot allows you to easily read and update this state through the use of two main hooks:
...
<Frame className="mt-0">
  <ImageZoom className="mt-0" src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/research-ana/fe-step-6-finish.png" alt="CopilotCloud API Key" height={1000} width={1000} />
</Frame>
