...
<Frame>
  <video controls autoPlay muted loop 
    src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/ai-travel-app/demo.mp4"
    alt="Travel app demo" 
...
<div className="flex flex-row gap-2">
  <Button size="lg" asChild className="flex gap-2 items-center">
    <Link href="https://github.com/neopilot-ai/neoai-ide/tree/main/examples/coagents-travel?ref=travel-tutorial" className="no-underline" target="_blank">
