...
LangGraph Studio is a tool for visualizing and debugging LangGraph workflows. It is not required for using NeoPilot but it is highly recommended
...
![LangGraph Studio](https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/ai-travel-app/lgs-overview.png)
...
![LangGraph Studio Progress](https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/ai-travel-app/lgs-progress.png)
...
![LangGraph Studio URL](https://cdn.neopilot.ai/docs/neopilot/images/coagents/tutorials/ai-travel-app/lgs-url.png)

Later in this tutorial, we'll be using this URL to connect NeoPilot to the LangGraph agent.
