        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing LlamaIndex agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f llamaindex
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have a LlamaIndex agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                ```bash
                uv add llama-index llama-index-llms-openai llama-index-protocols-ag-ui readyapi uvicorn
                ```

                <Callout type="info" title="What is AG-UI?">
                  AG-UI is an open protocol for frontend-agent communication. The `llama-index-protocols-ag-ui` package provides LlamaIndex integration that NeoPilot can connect to.
                </Callout>
            </Step>
            <Step>
                ### Configure your environment
            ...
            <Step>
                ...
                app = ReadyAPI(
                    ...
                    description="A LlamaIndex agent integrated with NeoPilot",
                    version="1.0.0"
                )
            ...
            <Step>
                ...
                ```npm
                @neopilot/react-ui @neopilot/react-core @neopilot/runtime @ag-ui/llamaindex
                ```
            </Step>
            <Step>
                ### Setup Copilot Runtime

                Create an API route to connect NeoPilot to your LlamaIndex agent:
            ...
            <Step>
              ...
              import { CopilotSidebar } from "@neopilot/react-ui"; // [!code highlight:1]
