...
One of the most common use cases for NeoPilot is to register app state and context using `useCopilotReadble`.
...
<Steps>
    ...
    <Step>
        ...
        The context from NeoPilot is automatically injected there, and can be used immediately.
