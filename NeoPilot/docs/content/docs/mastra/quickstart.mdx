        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing Mastra Agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f mastra
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have a Mastra Agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                ```package-install
                @neopilot/react-ui @neopilot/react-core @neopilot/runtime @ag-ui/mastra
                ```
            </Step>
            <Step>
                ### Setup Copilot Runtime

                Create an API route to connect NeoPilot to your Mastra agent:
                ...
                export default function RootLayout({ children }: {children: React.ReactNode}) {
                  return (
                    <html lang="en">
                      <body>
                        {/* [!code highlight:3] */}
                        <NeoPilot runtimeUrl="/api/neopilot" agent="myAgent">
                          {children}
                        </NeoPilot>
                      </body>
                    </html>
