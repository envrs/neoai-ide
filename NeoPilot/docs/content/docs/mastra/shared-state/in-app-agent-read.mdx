...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/mastra-agent-local/feature/shared_state?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/mastra-agent-local/feature/shared_state?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Callout type="info">
  This example demonstrates reading from shared state in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/mastra/feature/shared_state).
</Callout>
...
<Steps>
  ...
  <Step>
    ...
    Mastra has advanced [working memory concepts](https://mastra.ai/en/docs/memory/working-memory) to provide statefulness to your agents. NeoPilot leverages Mastra's working memory concept to allow you to
