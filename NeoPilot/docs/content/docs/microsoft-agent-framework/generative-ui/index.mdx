...
<Frame>
  <img
    src="https://cdn.neopilot.ai/docs/neopilot/images/coagents/AgenticGenerativeUI.gif"
    className="my-0"
...
To get started, you first need to decide what is going to be backing your generative UI. There are three main variants of Generative UI with NeoPilot for Microsoft Agent Framework.
