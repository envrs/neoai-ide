...
description: Bring your Microsoft Agent Framework agents to your users with NeoPilot via AG-UI.
hideHeader: true
hideTOC: true
---
...
<FrameworkOverview
  ...
  subheader="Give your Microsoft Agent Framework agents real user-interactivity using NeoPilot and AG-UI. Build rich, interactive, agent-powered applications."
  bannerVideo="https://cdn.neopilot.ai/docs/neopilot/videos/coagents/overview.mp4"
  guideLink="/microsoft-agent-framework/quickstart"
  initCommand="npx neopilot@latest create -f microsoft-agent-framework-dotnet"
  featuresLink="https://feature-viewer.neopilot.ai/microsoft-agent-framework-dotnet/feature"
  supportedFeatures={[
    {
      title: "Generative UI",
      ...
      demoLink: "https://feature-viewer.neopilot.ai/microsoft-agent-framework-dotnet/feature/backend_tool_rendering",
      videoUrl: "https://cdn.neopilot.ai/docs/neopilot/videos/coagents/haiku.mp4"
    },
    {
      ...
      demoLink: "https://feature-viewer.neopilot.ai",
      videoUrl: "https://cdn.neopilot.ai/docs/neopilot/images/coagents/human-in-the-loop-example.mp4"
    },
    {
      title: "Shared State",
      ...
      demoLink: "https://feature-viewer.neopilot.ai",
      videoUrl: "https://cdn.neopilot.ai/docs/neopilot/videos/coagents/shared-state.mp4"
    }
  ]}
  architectureImage="https://cdn.neopilot.ai/docs/neopilot/images/microsoft-agent-framework/maf-ag-ui.png"
  liveDemos={[
    {
      type: "feature-viewer",
      title: "Feature Viewer",
      description: "Explore all of the capabilities of the Microsoft Agent Framework combined with NeoPilot.",
      iframeUrl: "https://feature-viewer.neopilot.ai/microsoft-agent-framework-dotnet/feature/agentic_chat"
    },
  ]}
