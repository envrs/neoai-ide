...
<Steps>
  ...
  <Step>
    ...
    <Frame>
      <ImageZoom src="https://cdn.neopilot.ai/docs/neopilot/images/microsoft-agent-framework/read-agent-state.png" alt="read agent state" width={1000} height={1000} className="my-0"/>
    </Frame>

    <Callout type="info">
      Pictured above is the [agent starter](https://github.com/neopilot-ai/neopilot/tree/main/examples/agents-starter) with
...
```tsx title="ui/app/page.tsx"
import { useCoAgentStateRender } from "@neopilot/react-core"; // [!code highlight]
