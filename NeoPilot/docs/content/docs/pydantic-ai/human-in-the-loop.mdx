...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/pydantic-ai/feature/human_in_the_loop?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/pydantic-ai/feature/human_in_the_loop?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Steps>
    ...
    <Step>
        ...
        The frontend tools are automatically populated by NeoPilot through the AG-UI protocol and are available to your agent.
    </Step>
    <Step>
        ### Try it out!
