        ...
        header={
            <div>
                ...
                <p className="text-base">
                    You can either start fresh with our starter template or integrate NeoPilot into your existing Pydantic AI agent.
                </p>
            </div>
        }
    >
        ...
        >
            <Step>
                ...
                ```bash
                npx neopilot@latest create -f pydantic-ai
                ```
            </Step>
            <Step>
        ...
        <TailoredContentOption
            ...
            description="I already have a Pydantic AI agent and want to add NeoPilot."
        >
            <Step>
            ...
            <Step>
                ...
                <Callout type="info" title="What is AG-UI?">
                  AG-UI is an open protocol for frontend-agent communication. Pydantic AI's `.to_ag_ui()` method creates an ASGI app that NeoPilot can connect to.
                </Callout>
            </Step>
            <Step>
            ...
            <Step>
                ...
                Create an API route to connect NeoPilot to your Pydantic AI agent:
