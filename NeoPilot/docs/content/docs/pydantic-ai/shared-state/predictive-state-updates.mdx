...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.neopilot.ai/pydantic-ai/feature/shared_state?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.neopilot.ai/pydantic-ai/feature/shared_state?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Callout type="info">
  This example demonstrates predictive state updates in the [NeoPilot Feature Viewer](https://feature-viewer.neopilot.ai/pydantic-ai/feature/shared_state).
</Callout>
