...
description: "Copilot Runtime is the back-end component of NeoPilot, enabling interaction with LLMs."
---

{
  ...
  * NeoPilot/packages/runtime/src/lib/runtime/copilot-runtime.ts
  */
}
<Callout type="info">
...
<PropertyReference name="remoteActions" type="NeoPilotEndpoint[]"  > 
