...
<Tabs groupId="component" items={["CopilotChat", "CopilotSidebar", "CopilotPopup", "Headless UI"]}>
  ...
  <Tab value="CopilotSidebar">
    ...
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/sidebar-example.gif" alt="Popup Example" className="w-full rounded-lg my-4" />
  ...
  <Tab value="CopilotChat">
    ...
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/copilotchat-example.gif" alt="Popup Example" className="w-full rounded-lg my-4" />
