...
Navigate to <LinkToCopilotCloud asButton={false}>cloud.neopilot.ai</LinkToCopilotCloud> and follow the video!
...
<Frame className="mt-4">
    <img src="https://cdn.neopilot.ai/docs/neopilot/images/copilot-cloud/cpk-cloud-lgp-endpoint.gif" alt="Configure Remote Endpoint LangGraph" />
</Frame>

🎉 You should now see your LangGraph agent in the list of available agents in NeoPilot!