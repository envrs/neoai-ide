...
The starting point for this section is the `CopilotRuntime` you set up during quickstart (the NeoPilot backend endpoint).
...
If you followed the quickstart, it'll be where you set up the `/api/neopilot` endpoint.
