...
If you are not sure yet, simply ignore this note.
    ...
    <Callout type="warn">
        ...
        When deploying to serverless platforms (Vercel, AWS Lambda, etc.), be aware that default function timeouts may be too short for NeoPilot's streaming responses:
        ...
        **Solution options:**
        1. Increase function timeout:
            ...
            ```
        2. Use [Copilot Cloud](https://cloud.neopilot.ai/) to avoid timeout issues entirely
    </Callout>
    ...
    <Tabs groupId="endpoint-type" items={[
        ...
        <Tab value="NestJS">
            ...
            import { CopilotRuntime, copilotRuntimeNestEndpoint, {{adapterImport}} } from '@neopilot/runtime';
