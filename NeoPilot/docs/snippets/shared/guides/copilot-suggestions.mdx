...
<Frame>
  <img
    src="https://cdn.neopilot.ai/docs/neopilot/images/use-copilot-chat-suggestions/use-copilot-chat-suggestions.gif"
    width="500"
  />
</Frame>
...
```tsx
import { useCopilotChatSuggestions } from "@neopilot/react-ui"; // [!code highlight]
