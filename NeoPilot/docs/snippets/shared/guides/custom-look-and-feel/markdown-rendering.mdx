...
When rendering an assistant message, NeoPilot uses [`react-markdown`](https://remarkjs.github.io/react-markdown/) under the hood.
...
<Frame>
    <img className="rounded-none w-80" src="https://cdn.neopilot.ai/docs/neopilot/images/custom-markdown-example.png" />
</Frame>
...
import { CopilotSidebar, ComponentsMap } from "@neopilot/react-ui";
