...
>
  The Fully Headless UI extension is in Early Access to NeoPilot Premium users. As it matures, it will become available as part of the core framework.

  - Get started with your public license key from [Copilot Cloud](https://cloud.neopilot.ai) 
...
NeoPilot offers *fully headless UI* through the `useCopilotChatHeadless_c` hook. By using this hook, you can build your own chat interfaces
from the ground up while still utilizing NeoPilot's core features and ease-of-use.

## Navigation
This page has all the information you need to get started with NeoPilot's headless UI. Select where you'd like to get started below.
...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/videos/full-headless-chat.mp4"
...
<Steps>
  ...
  <Step>
    ### Set up your NeoPilot provider
    You will need to provide your public license key to the `NeoPilot` provider component. Get yours on [Copilot Cloud](https://cloud.neopilot.ai) or read more about [premium features](/premium).
  ...
  <Step>
    ...
    import { useCopilotChatHeadless_c } from "@neopilot/react-core"; // [!code highlight]
...
<video
  src="https://cdn.neopilot.ai/docs/neopilot/videos/gen-ui.mp4"
  className="rounded-xl shadow-lg border"
  loop
  playsInline
  autoPlay
...
NeoPilot's standard components utilize `useCopilotAction` to allow tools to be both rendered and called in 
...
NeoPilot's suggestions are a way to provide your users with a list of suggestions to operate the chat with. When utilizing
Headless UI, you have full control over the lifecycle of these suggestions.

<video
  src="https://cdn.neopilot.ai/docs/neopilot/videos/suggestions.mp4"
  className="rounded-xl shadow-lg border"
  loop
  playsInline
  autoPlay
...
```tsx title="src/app/components/chat.tsx"
import { useCopilotChatHeadless_c, useCopilotChatSuggestions } from "@neopilot/react-core"; // [!code highlight]
...
NeoPilot's human-in-the-loop (HITL) features allows you to pause the chat and wait for a human to respond. This comes 
in two flavors: **tool-based** and **interrupt-based** (for certain frameworks).

<video
  src="https://cdn.neopilot.ai/docs/neopilot/videos/hitl.mp4"
  className="rounded-xl shadow-lg border"
  loop
  playsInline
  autoPlay
...
```tsx title="src/app/components/chat.tsx"
import { useCopilotAction, useCopilotChatHeadless_c } from "@neopilot/react-core";
