...
## What is NeoPilot Premium?
NeoPilot Premium plans deliver:
- A commercial license for premium extensions to the open source NeoPilot framework (self-hosted or using Copilot Cloud)
- Access to the Copilot Cloud hosted service. 

NeoPilot Premium is designed for teams building production-grade, agent-powered applications with NeoPilot.
...
The Developer tier of NeoPilot Premium is always free.
...
All NeoPilot Premium subscribers get early access to new features, tooling, and integrations as they are released.

## Current Premium Features
- [Fully Headless Chat UI](headless-ui) - Early Access
- [Observability Hooks](observability)
- [Copilot Cloud](https://cloud.neopilot.ai)
...
All NeoPilot Premium features are included in Copilot Cloud. 
...
<Steps>
  <Step>
    ...
    Create a *free* account on [Copilot Cloud](https://cloud.neopilot.ai).
  ...
  <Step>
    ...
    Once you've signed up, you'll be able to use the public license key in your NeoPilot instance.

    ```tsx title="layout.tsx"
    <NeoPilot publicLicenseKey="your-public-license-key" />
    ```
  </Step>
</Steps>
