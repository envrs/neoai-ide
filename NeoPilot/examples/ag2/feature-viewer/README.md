...
A modern, interactive viewer for exploring NeoPilot agent demos with a clean, responsive UI and dark/light theme support.

## Overview

The Demo Viewer provides a centralized interface for browsing, viewing, and exploring the source code of various NeoPilot agent demos. It features:
