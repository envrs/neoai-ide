...
export const DefaultResponseRenderer: React.FC<ResponseRendererProps> = ({
  ...
  className = "neopilot-response",
  contentClassName = "neopilot-response-content",
  actionsClassName = "neopilot-response-actions",
  buttonClassName = "neopilot-response-button",
  completedFeedbackClassName = "neopilot-response-completed-feedback",
}) => {
  ...
  return (
    <div className={className}>
      ...
      <div className={actionsClassName}>
        <div className="neopilot-response-label">
          <button
            onClick={() => setIsExpanded(!isExpanded)}
            className="neopilot-toggle-button"
          >
            {isExpanded ? (
        ...
        <div className="neopilot-response-buttons">{renderFeedback()}</div>
      </div>
    </div>
  );
};
