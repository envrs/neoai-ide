...
import uvicorn
from neopilot.integrations.readyapi import add_readyapi_endpoint, NeoPilotRemoteEndpoint
...
# Create a NeoPilot endpoint with our custom PersistenceAgent
...
# Register the standard NeoPilot endpoint
