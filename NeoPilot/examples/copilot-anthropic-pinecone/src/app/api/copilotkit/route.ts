          ...
          return {
            ...
            content_summary:
              formattedResults.length > 0
                ? "Here are the key NeoPilot features found in our knowledge base:\n" +
                  formattedResults
                    .map(
                      (result, i) =>
                    ...
                    .join("\n\n")
                : "No relevant articles found about NeoPilot features. The knowledge base may not contain comprehensive documentation.",
          };
        } catch (error) {
