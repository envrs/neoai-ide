...
export const posts: Post[] = [
  {
    id: 1,
    title: "Getting Started with NeoPilot",
    summary:
      "Learn the basics of NeoPilot and how to set up your first project.",
    content: `
        NeoPilot is an open-source framework for building AI copilots and assistants for your applications. Here's how to get started:
        
        1. Installation: Install NeoPilot using npm or yarn with 'npm install @neopilot/react-core @neopilot/react-ui @neopilot/runtime'.
        
        2. Basic Setup: Import and set up the NeoPilot provider in your application's root component.
        
        3. Configuration: Configure your OpenAI or Anthropic API keys in your environment variables to connect your AI service.
        
        4. Add Components: Use NeoPilot's UI components like CopilotSidebar or CopilotChat to add AI assistance to your app.
        
        5. Testing: Test your implementation locally to ensure proper functionality before deploying.
        
        For more detailed information, visit the official documentation at https://docs.neopilot.ai
      `,
    category: "Basics",
  ...
  {
    id: 2,
    title: "Key Features of NeoPilot",
    summary: "Comprehensive overview of all NeoPilot's powerful features.",
    content: `
        NeoPilot offers a comprehensive set of features for building AI-powered assistants:
        ...
        10. Custom Styling: Fully customize the appearance of all NeoPilot components to match your application's design.
      `,
    category: "Features",
    createdAt: "2024-11-21",
  },
  {
    id: 3,
    title: "Implementing NeoPilot Components",
    summary:
      "Learn how to use the different components provided by NeoPilot.",
    content: `
        NeoPilot provides several key components for your applications:
        ...
        4. CopilotContext: Wrap your application with this provider to enable global access to NeoPilot features:
           <CopilotContext>
             <YourApp />
           </CopilotContext>
  ...
  },
  {
    ...
    summary:
      "Follow these steps to troubleshoot common issues when using NeoPilot.",
    content: `
        When troubleshooting NeoPilot implementations, follow these steps:
        
        1. Check API Configuration: Ensure your OpenAI or Anthropic API keys are correctly set in your environment variables.
        
        2. Verify SDK Integration: Confirm that your React app properly imports and uses NeoPilot components and hooks.
        
        3. Inspect Console Logs: Check your browser or server console for error messages that might indicate configuration issues.
        
        4. Component Setup: Verify that NeoPilot components have proper instructions and configuration props.
        
        5. Actions and Context: Ensure that any CopilotActions or context providers are correctly implemented with proper typings.
        
        6. Version Compatibility: Make sure you're using compatible versions of all NeoPilot packages.
  ...
  {
    id: 5,
    title: "Advanced NeoPilot Usage",
    summary:
      "Take your NeoPilot implementation to the next level with advanced techniques.",
    content: `
        Advanced techniques for leveraging NeoPilot in your applications:
        
        1. Custom LLM Integration: Connect NeoPilot to any LLM provider beyond OpenAI and Anthropic using custom adapters.
