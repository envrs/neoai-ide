    ...
    <Container size="md" py="xl" ml="xl">
      <Stack gap="xl">
        <Group justify="center" align="center">
          <BookOpen size={32} />
          <Title order={1}>NeoPilot Product Knowledge Base</Title>
        </Group>
        ...
        <Group justify="center" style={{ width: "100%" }}>
          <Box style={{ flex: 1, maxWidth: "350px" }}>
            <CopilotSidebar
              instructions={`You are a helpful assistant for NeoPilot. When users ask about NeoPilot features or usage:
1. ALWAYS use the FetchKnowledgebaseArticles action immediately to retrieve information
2. Read the content_summary in the response - this contains formatted information about NeoPilot
...
5. Always mention specific NeoPilot features and how to use them based on the retrieved data
Never respond with "I couldn't retrieve specific details" as the knowledge base contains comprehensive information about NeoPilot features.`}
              labels={{
                initial:
                  "Welcome! I'm your NeoPilot assistant. Ask me anything about NeoPilot features or how to use it!",
              }}
              defaultOpen={true}
