...
Transform your data visualization experience with an AI-powered dashboard assistant. Ask questions about your data in natural language, get insights, and interact with your metrics—all through a conversational interface powered by NeoPilot.
...
<div align="center">
  ...
  <a href="https://neopilot.ai" target="_blank">
    <img src="https://img.shields.io/badge/Built%20with-NeoPilot-6963ff" alt="Built with NeoPilot"/>
  </a>
...
1. Clone the repository:
   ...
   cd NeoPilot/examples/copilot-chat-with-your-data
   ```
...
- `openCopilot=true` - Automatically opens the NeoPilot sidebar when the page loads
  - Example: `http://localhost:3000?openCopilot=true`

## 🧩 How It Works

This demo showcases several powerful NeoPilot features:
...
<em>[app/api/neopilot/route.ts](./app/api/neopilot/route.ts)</em>
...
### CSS Customization
The dashboard uses CSS variables to customize the appearance of the NeoPilot components to match the dashboard's design system.
...
/* Custom NeoPilot styling to match dashboard */
...
[NeoPilot Documentation](https://docs.neopilot.ai) - Comprehensive guides and API references to help you build your own copilots.

[NeoPilot Cloud](https://cloud.neopilot.ai/) - Deploy your copilots with our managed cloud solution for production-ready AI assistants.
