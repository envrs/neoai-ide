...
NeoPilot fully customized using components from MongoDB's Leafy Green Design System.
...
NeoPilot requires `runtime`, a production-ready proxy for your LLM requests. You can either use Copilot Cloud or self-host it.
...
Now, you can either provide your [Copilot Cloud public API key](https://cloud.neopilot.ai) or [OpenAI API key](https://platform.openai.com/api-keys).
...
This project demonstrates how to fully customize NeoPilot using components from MongoDB's Leafy Green Design System.
