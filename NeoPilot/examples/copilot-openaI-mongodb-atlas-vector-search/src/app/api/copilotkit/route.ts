...
import { CopilotRuntime, OpenAIAdapter, copilotRuntimeNextJSAppRouterEndpoint } from "@neopilot/runtime";
...
//neopilot runtime with the search functionality -- each query is converted to an embedding and then the search is performed on the vector index
