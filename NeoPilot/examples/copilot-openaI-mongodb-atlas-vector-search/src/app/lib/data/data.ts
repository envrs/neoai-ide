  ...
  export const posts: Post[] = [
    {
      ...
      content: `
        ...
        Integrate your React app with NeoPilot using the provided SDK.
        Test your setup by running the app in your local environment.
        Review NeoPilot’s documentation for additional setup and troubleshooting.
      `,
      category: "Basics",
    ...
    {
      id: 2,
      title: "Advanced Features of NeoPilot",
      summary:
        " NeoPilot advanced features.",
      content: `
    ...
    },
    {
      ...
      content: `
        Step 1: Check SDK Integration: Ensure that your React app is properly integrated with the NeoPilot SDK. 
