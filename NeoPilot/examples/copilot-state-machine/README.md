...
The example showcases how to implement complex conversational flows using a state machine pattern with NeoPilot.
...
1. Clone the repository:
   ...
   cd NeoPilot/examples/copilot-state-machine
   ```
...
3. Create a `.env` file in the project root and add your [Copilot Cloud Public API Key](https://cloud.neopilot.ai):
   ```
...
This demo uses several key NeoPilot features to implement a state machine pattern:
...
Each stage hook encapsulates stage-specific NeoPilot configuration and prompts.
...
### NeoPilot Integration

Each stage uses NeoPilot's hooks to provide context-aware AI assistance:
...
- [NeoPilot Documentation](https://docs.neopilot.ai) - Comprehensive guides and API references
- [NeoPilot Cloud](https://cloud.neopilot.ai/) - Deploy your copilots with our managed cloud solution
