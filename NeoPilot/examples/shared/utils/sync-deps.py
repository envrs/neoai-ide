#!/usr/bin/env python3
"""
NeoPilot Dependency Synchronization Script
...
CANONICAL_VERSIONS = {
    "python": ">=3.10,<3.13",  # Compatible with NeoPilot requirement
    "neopilot": "0.1.49",
    "langchain": "0.3.21",
    "langgraph": "0.3.18",
    "langsmith": "0.3.18",
...
REQUIREMENTS_TEMPLATE = """# NeoPilot standardized dependencies for pip compatibility
