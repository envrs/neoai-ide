...
import { CatchAllActionRenderProps, useCoAgent, useDefaultTool, useLangGraphInterrupt } from "@neopilot/react-core";
import { CopilotChat, NeoPilotCSSProperties } from "@neopilot/react-ui";
...
export default function Page() {
  const { state, setState, running } = useCoAgent({
    name: process.env.NEXT_PUBLIC_NEOPILOT_AGENT_NAME || "",
  });
