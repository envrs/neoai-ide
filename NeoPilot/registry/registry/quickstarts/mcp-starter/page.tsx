...
import { useCopilotChat, useDefaultTool, CatchAllActionRenderProps } from "@neopilot/react-core";
import { NeoPilotCSSProperties, CopilotSidebar, useCopilotChatSuggestions } from "@neopilot/react-ui";
import { MCPEndpointConfig } from "@neopilot/runtime";
import { DefaultToolRender } from "@/registry/quickstarts/mcp-starter/components/default-tool-render";

const themeColor = "#6366f1";

export default function NeoPilotPage() {
  return (
    <main style={{ "--copilot-kit-primary-color": themeColor } as NeoPilotCSSProperties}>
      <YourMainContent />
      <CopilotSidebar
        ...
        labels={{
          ...
          initial: "👋 Hi, there! You're chatting with an LLM that can use MCP servers.\n\n Since you scaffolded me with **NeoPilot**, you can ask me to use any MCP servers that you have set up on this page.\n\nIn your codebase, check out this page's code to see how it all works! You can also [checkout our documentation](https://docs.neopilot.ai/guides/model-context-protocol) for any questions.\n\nNow, what can I do for you?"
        }}
      />
    </main>
  );
...
function YourMainContent() {
  ...
  // 🪁 Copilot Suggestions: https://docs.neopilot.ai/guides/copilot-suggestions
  ...
  // 🪁 Catch-all Tool Rendering for MCP tool calls: https://docs.neopilot.ai/guides/generative-ui?gen-ui-type=Catch+all+renders
  useDefaultTool({
