import { MCPTool, MCPClient as MCPClientInterface } from "@neopilot/runtime";
 ...
 * NeoPilot's runtime by exposing the required interface.
 *
 * The main methods required by NeoPilot are:
...
export class MCPClient implements MCPClientInterface {
   ...
   * This method matches the expected NeoPilot interface
   */
   ...
   * (Legacy method, prefer using close() for compatibility with NeoPilot)
   */
