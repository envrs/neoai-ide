...
import { useFrontendTool, useCopilotReadable } from "@neopilot/react-core";
...
export default function NeoPilotPage() {
  ...
  // 🪁 Frontend Tools: https://docs.neopilot.ai/guides/frontend-tools
  useFrontendTool({
    name: "setThemeColor",
...
function YourMainContent({ themeColor }: { themeColor: string }) {
  ...
  // 🪁 Frontend Readables: https://docs.neopilot.ai/guides/connect-your-data/frontend
  useCopilotReadable({
  ...
  //🪁 Generative UI: https://docs.neopilot.ai/guides/generative-ui
  useFrontendTool({
