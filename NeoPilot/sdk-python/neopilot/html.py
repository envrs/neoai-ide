...
"""
import json
from neopilot.sdk import InfoDict

HEAD_HTML = """
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>NeoPilot Remote Endpoint v0.1.12</title>
    <style>
        body {
...
<body>
    <div class="container">
        <header>
            <h1><span class="kite-icon">🪁</span>NeoPilot Remote Endpoint <span class="version">(v{version})</span></h1>
        </header>
